...
void main() {
  final FlutterScreenDataLeakageProtectorPlatform initialPlatform =
      FlutterScreenDataLeakageProtectorPlatform.instance;

  test(
    '$MethodChannelFlutterScreenDataLeakageProtector is the default instance',
    () {
      expect(
        initialPlatform,
        isInstanceOf<MethodChannelFlutterScreenDataLeakageProtector>(),
      );
    },
  );
}
